...
**交付物**：一个自包含的 Agent Skill 包，提供中英双语两个版本：

- 中文版 → [`skills/biomed-paper-review/`](skills/biomed-paper-review/)
- 英文版 → [`skills/biomed-paper-review-en/`](skills/biomed-paper-review-en/)

两个版本功能一致：脚本、schema、离线 fixture 完全等价，仅文档语言不同。
...
> 以下命令以中文版 `skills/biomed-paper-review/` 为例；
> 换成 `skills/biomed-paper-review-en/` 即为英文版，行为一致。
...
```
skills/biomed-paper-review/        中文版（skills/biomed-paper-review-en/ 为等价英文版）
